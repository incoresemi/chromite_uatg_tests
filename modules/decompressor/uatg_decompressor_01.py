...
class uatg_decompressor_01(IPlugin):
    ...
    def generate_covergroups(self, config_file):
        ...
        sv = f"covergroup mkstage1_cg @(posedge CLK);\noption.per_instance=1;" \
             ...
             f"{fn_decompress_inst}_cp : coverpoint {fn_decompress_inst}"
        sv += "{\n  wildcard bins ILLEGAL    	       = {16'b0}; \n  wildcar" \
              "d bins C_ADDI4SPN 	       = {16'b000_xxxxxxxx_xxx_00};//(RES" \
              ", nzuimm=0) \n  //wildcard bins C_ADDI4SPN_RESERVED  = {16'b00" \
              "0_00000000_xxx_00};\n  wildcard bins C_FLD	               = " \
              "{16'b001_xxx_xxx_xx_xxx_00};\n  wildcard bins C_LW 	         " \
              "      = {16'b010_xxx_xxx_xx_xxx_00};\n  wildcard bins C_FSD	 " \
              "              = {16'b101_xxx_xxx_xx_xxx_00};\n  wildcard bins " \
              "C_SW	               = {16'b110_xxx_xxx_xx_xxx_00};\n  //wildca" \
              "rd bins RESERVED             = {16'b100_xxxxxxxx_xxx_00};\n\n`" \
              "ifdef RV32\n  wildcard bins C_FSW	               = {16'b111" \
              "_xxx_xxx_xx_xxx_00};\n  wildcard bins C_FLW	               = " \
              "{16'b011_xxx_xxx_xx_xxx_00};\n`endif\n`ifdef RV64\n  wildcard " \
              "bins C_SD	               = {16'b111_xxx_xxx_xx_xxx_00};\n  " \
              "wildcard bins C_LD	 	       = {16'b011_xxx_xxx_xx_xxx_00};" \
              "\n`endif\n  //---RVC, Quadrant 1 instructions----//\n  wildcar" \
              "d bins C_NOP	               = {16'b000_x_00000_xxxxx_01};//(HI" \
              "NT, nzimm! = 0)\n  wildcard bins C_ADDI	               = {16'" \
              "b000_x_xxxxx_xxxxx_01} iff (fn_decompress_inst[11:7]!=5'b0);//" \
              "(HINT, nzimm = 0)\n  wildcard bins C_LI	               = {16'" \
              "b010_x_xxxxx_xxxxx_01} iff (fn_decompress_inst[11:7]!=5'b0);//" \
              "(HINT, rd=0)\n  wildcard bins C_ADDI16SP             = {16'b01" \
              "1_x_00010_xxxxx_01} ;//(RES, nzimm=0)\n  //illegal_bins C_ADDI" \
              "16SP_RESERVED   = {16'b011_0_00010_00000_01} ;//(RES, nzimm=0)" \
              "\n  wildcard bins C_LUI                  = {16'b011_x_xxxxx_xx" \
              "xxx_01} iff (fn_decompress_inst[11:7]!=5'b0 && fn_decompress_i" \
              "nst[11:7]!=5'd2);//(RES, nzimm=0; HINT, rd=0)\n  //wildcard bi" \
              "ns C_LUI_RESERVED       = {16'b011_0_xxxxx_00000_01} iff (fn_d" \
              "ecompress_inst[11:7]!=5'b0 && fn_decompress_inst[11:7]!=5'd2);" \
              "//(RES, nzimm=0; HINT, rd=0)\n  wildcard bins C_ANDI	         " \
              "      = {16'b100_x_10_xxx_xxxxx_01};\n  wildcard bins C_SUB	 " \
              "	       = {16'b100_0_11_xxx_00_xxx_01};\n  wildcard bins C_XOR" \
              "	               = {16'b100_0_11_xxx_01_xxx_01};\n  wildcard bi" \
              "ns C_OR	               = {16'b100_0_11_xxx_10_xxx_01};\n  wil" \
              "dcard bins C_AND	               = {16'b100_0_11_xxx_11_xxx_01}" \
              ";\n  wildcard bins C_J	               = {16'b101_x_xx_xxx_xx" \
              "_xxx_01};\n  wildcard bins C_BEQZ                 = {16'b110_x" \
              "xx_xxx_xxxxx_01};\n  wildcard bins C_BNEZ	               = " \
              "{16'b111_xxx_xxx_xxxxx_01};\n  //wildcard bins C_SRLI64	     " \
              "  = {16'b100_0_00_xxx_00000_01};//(RV128; RV32/64 HINT)\n  //w" \
              "ildcard bins C_SRAI64	       = {16'b100_0_01_xxx_00000_01};" \
              "//(RV128; RV32/64 HINT)\n  //wildcard bins RESERVED_1	     " \
              "  = {16'b100_1_11_xxx_10_xxx_01};\n  //wildcard bins RESERVED_" \
              "2           = {16'b100_1_11_xxx_11_xxx_01};\n`ifdef RV32\n  wi" \
              "ldcard bins C_JAL	               = {16'b001_xxxxxxxxxxx_01}" \
              ";//(RV32)\n  wildcard bins C_SRLI	               = {16'b100" \
              "_1_00_xxx_xxxxx_01};//(RV32 Custom, nzuimm[5]=1) //change\n  /" \
              "/illegal_bins C_SUBW_RESERVED       = {16'b100_1_11_xxx_00_xxx" \
              "_01};//(RV64/128; RV32 RES)\n  //illegal_bins C_ADDW_RESERVED " \
              "      = {16'b100_1_11_xxx_01_xxx_01};//(RV64/128; RV32 RES)\n " \
              " wildcard bins C_SRAI	               = {16'b100_1_01_xxx_xx" \
              "xxx_01};//(RV32 Custom, nzuimm[5]=1)\n`endif\n`ifdef RV64\n  w" \
              "ildcard bins C_ADDIW	               = {16'b001_x_xxxxx_xxxxx_0" \
              "1} iff (fn_decompress_inst[11:7]!=5'b0);//(RV64/128; RES, rd=0" \
              ")\n  //wildcard bins C_ADDIW_RESERVED     = {16'b001_x_xxxxx_x" \
              "xxxx_01} iff (fn_decompress_inst[11:7]==5'b0);//(RV64/128; RES" \
              ", rd=0)\n  wildcard bins C_SUBW	               = {16'b100_1_1" \
              "1_xxx_00_xxx_01};//(RV64/128; RV32 RES)\n  wildcard bins C_ADD" \
              "W	               = {16'b100_1_11_xxx_01_xxx_01};//(RV64/128" \
              "; RV32 RES)\n`endif\n  //---RVC, Quadrant 2 instructions---//\
              n  //wildcard bins C_SLLI64	       = {16'b000_0_xxxxx_00000_1" \
              "0} iff (fn_decompress_inst[11:7]!=5'b0); //(RV128; RV32/64 HIN" \
              "T; HINT, rd=0)\n  wildcard bins C_FLDSP	               = {16'" \
              "b001_x_xxxxx_xxxxx_10}; //( RV32/64)\n  wildcard bins C_LWSP	 " \
              "              = {16'b010_x_xxxxx_xxxxx_10}  iff (fn_decompress" \
              "_inst[11:7]!=5'b0); //(RES,rd=0)\n  //wildcard bins C_LWSP_RES" \
              "ERVED      = {16'b010_x_xxxxx_xxxxx_10}  iff (fn_decompress_in" \
              "st[11:7]==5'b0); //(RES,rd=0)\n  wildcard bins C_JR	         " \
              "      = {16'b100_0_xxxxx_00000_10}  iff (fn_decompress_inst[11" \
              ":7]!=5'b0); //(RES,rs1=0)\n  //wildcard bins C_JR_RESERVED	 " \
              "      = {16'b100_0_xxxxx_00000_10}  iff (fn_decompress_inst[11" \
              ":7]==5'b0); //(RES,rs1=0)\n  wildcard bins C_MV	 	       = " \
              "{16'b100_0_xxxxx_xxxxx_10}  iff (fn_decompress_inst[11:7]!=5'b" \
              "0 && (fn_decompress_inst[6:2]!=5'b0) ); //(HINT, rd=0)\n  wild" \
              "card bins C_EBREAK	       = {16'b100_1_00000_00000_10};\n  w" \
              "ildcard bins C_JALR	               = {16'b100_1_xxxxx_00000_1" \
              "0}  iff (fn_decompress_inst[11:7]!=5'b0);\n  wildcard bins C_A" \
              "DD	               = {16'b100_1_xxxxx_xxxxx_10}  iff (fn_deco" \
              "mpress_inst[11:7]!=5'b0 && (fn_decompress_inst[6:2]!=5'b0) );/" \
              "/(HINT, rd=0)\n  wildcard bins C_FSDSP	               = {16'" \
              "b101_xxxxxx_xxxxx_10};//(RV32/64)\n  wildcard bins C_SWSP	 " \
              "              = {16'b110_xxxxxx_xxxxx_10};//(RV32/64)\n\n\n`if" \
              "def RV32	\n  wildcard bins C_SLLI	               = {16'b000" \
              "_x_xxxxx_xxxxx_10} iff (fn_decompress_inst[11:7]!=5'b0);//(HIN"
        return sv
