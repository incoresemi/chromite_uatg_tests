...
class utg_gshare_fa_ghr_alternating_01(IPlugin):
    ...
    def execute(self, _bpu_dict):
        ...
        self._history_len = _bpu_dict['history_len'] # states the length of the history register

        if _en_bpu and self._history_len: # check condition, if BPU exists and history len is valid
    ...
    def check_log(self, log_file_path, reports_dir):
        ...
        train_existing_result = re.findall(rf.train_existing_pattern, log_file) # we choose the pattern among the pre-written patterns 
