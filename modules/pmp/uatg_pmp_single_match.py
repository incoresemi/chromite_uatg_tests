...
class uatg_pmp_single_match(IPlugin):
    ...
    def generate_asm(self) -> Dict[str, Union[Union[str, list], Any]]:
        ...
        asm += helpers.config_pmp(max(pmps),'t0','BFFFFFFF',
