...
#    Created On:  Mon Sep 19, 2022 11:41:57
#    Author(s):
...
class uatg_pmp_u_partial(IPlugin):
    ...
    def execute(self,core_yaml,isa_yaml) -> bool:
        ...
        return helpers.is_pmp_present(isa_yaml) and 'U' in isa_yaml['hart0']['ISA'] and  \
            '64' in isa_yaml['hart0']['ISA'] and isa_yaml['hart0']['pmp_granularity'] == 0
