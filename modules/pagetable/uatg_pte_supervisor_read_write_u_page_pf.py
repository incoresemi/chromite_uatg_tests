...
class uatg_pte_supervisor_read_write_u_page_pf(IPlugin):
    """
    ...
    def generate_asm(self) -> Dict[str, Union[Union[str, list], Any]]:
        """
            ...
            test tries to write to a page marked U
        """
                ...
                for sum_b in sum_list:
                    ...
                    for inst in inst_list:
                        ...
                        yield ({
                            ...
                            'docstring': '',
                            'name_postfix': f"{inst}-sum-{sum_b}-{mode}-{paging_mode}"
                        })
