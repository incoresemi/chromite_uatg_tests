...
class uatg_pte_non_u_page_inst_pf(IPlugin):
    """
        the test is used to setup write only page and check the
    ...
    def generate_asm(self) -> Dict[str, Union[Union[str, list], Any]]:
        """
            ...
            ths U mode only test will raise a Instruction access fault 
            as the U bit in PTE is 0 in this test.
        """
            ...
            for paging_mode in self.paging_modes:
                ...
                privileged_test_dict = {
                    ...
                    'pte_dict' : {'valid': True,
                        ...
                        'write': True,
                        'execute': True,
                        'user': False if mode=='user' else False,
                        'globl': True,
                        'access': True,
                        'dirty': True}
                }
