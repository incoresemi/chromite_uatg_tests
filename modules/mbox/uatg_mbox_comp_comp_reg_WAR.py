...
class uatg_mbox_comp_comp_reg_WAR(IPlugin):
    """
    ...
    def generate_asm(
        ...
        """
         ...
         It creates asm for the following instructions based upon 
         ISA c.and, c.or, c.xor, c.sub with compressed 
        ...
        # compressed (reg-reg) instructions.
