...
class uatg_mbox_comp_mul_rv64_imm_WAR(IPlugin):
    """
    ...
    def generate_asm(self) -> Dict[str, str]:
        """
            ...
            with compressed instructions(rv64-imm) 
        """
        # compressed instructions for CI format has no limit to use the registers it will support x0 to x31 registers.
        # Test to validate the mextension instructions with compressed (rv64-imm) instructions.
