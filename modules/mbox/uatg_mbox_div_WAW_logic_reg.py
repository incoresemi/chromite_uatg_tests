...
class uatg_mbox_div_WAW_logic_reg(IPlugin):
    """
        ...
        for inst in instruction_list:
            ...
            for i in range(self.div_stages):
                 ...
                 for j in range(i):
                     ...
                     if rand_rd in [rs1, rs2, rd1, rand_rs1, rand_rs2, swreg, testreg]:
                             new_rand_rd = random.choice([
                                   x for x in reg_file
                                   if x not in [rs1, rs2, rs3, rs4, rd1, rand_rs1, rand_rs2, swreg, testreg]
                                   ])
                             rand_rd = new_rand_rd
                     if rand_rs1 in [rd1, rs2, rs3, rs4, rand_rd, rand_rs2, rs1, swreg, testreg]:
                             new_rand_rs1 = random.choice([
                                   x for x in reg_file
                                   if x not in [rd1, rs2, rs3, rs4, rand_rd, rand_rs2, rs1, swreg, testreg]
                                   ])
                             rand_rs1 = new_rand_rs1
                     if rand_rs2 in [rs1, rd1, rand_rs1, rand_rd, rs2, rs3, rs4, swreg, testreg]:
                             new_rand_rs2 = random.choice([
                                   x for x in reg_file
                                   if x not in [rs1, rd1, rand_rs1, rand_rd, rs2, rs3, rs4, swreg, testreg]
                                   ])
            ...
            #rs2_val = '4' 
                        ...
                        # value to it.
            if swreg in [rd1, rs1, rs2, rs3, rs4, rand_rs1, rand_rs2, rand_rd, testreg ]:
                 newswreg = random.choice([
                     x for x in reg_file
                     if x not in [rd1, rs1, rs2, rs3, rs4, rand_rs1, rand_rs2, rand_rd, testreg]
                     ])
