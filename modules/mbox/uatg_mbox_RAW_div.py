    ...
    def generate_asm(self) -> Dict[str, str]:
        ...
        for inst in instruction_list:
                 ...
                 for j in range(i):
                     ...
                     if rand_rd in [rs1, rs2, rd1, rand_rs1, rand_rs2,rd2]:
                             new_rand_rd = random.choice([
                                   x for x in reg_file
                                   if x not in [rs1, rs2, rd1, rand_rs1, rand_rs2, rd2]
                                   ])
                             rand_rd = new_rand_rd
                     if rand_rs1 in [rd1, rs2, rd2, rand_rd, rand_rs2, rs1]:
                             new_rand_rs1 = random.choice([
                                   x for x in reg_file
                                   if x not in [rd1, rs2, rd2, rand_rd, rand_rs2, rs1]
                                   ])
            ...
            #rs2_val = '4' 
                        ...
                        # value to it.
            if swreg in [rd1, rs1, rs2, rd2]:
                 newswreg = random.choice([
                     x for x in reg_file
                     if x not in [rd1, rs1, rs2, rd2]
                     ])
