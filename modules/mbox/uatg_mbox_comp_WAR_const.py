...
class uatg_mbox_comp_WAR_const(IPlugin):
    """
    ...
    def generate_asm(
        ...
        """
         Generates the ASM instructions for multiplier 
         dependencies with compressed instructions.
         It creates asm for the following instructions based 
         upon ISA mul[w], mulh, mulhsu, mulhu 
        ...
        if 'i' in self.isa:
            random_list += compressed_instructions[f'reg-const']
