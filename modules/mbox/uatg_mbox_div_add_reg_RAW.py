...
class uatg_mbox_div_add_reg_RAW(IPlugin):
    """ 
     This tets case is to  evaluate the mbox test with read after
     write dependency with mext instructions(div, divu, rem, remu,divuw,
     remuw, divw,remw) and arithmetic instructions(add, addw, sub, su
    """
