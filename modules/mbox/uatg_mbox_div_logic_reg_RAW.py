...
class uatg_mbox_div_logic_reg_RAW(IPlugin):
    """
        ...
        for inst in instruction_list:
            ...
            for i in range(self.div_stages):
                 ...
                 for j in range(i):
                     ...
                     if rand_rd in [rs1, rs2, rd1, rand_rs1, rand_rs2, rd2, swreg]:
                             new_rand_rd = random.choice([
                                   x for x in reg_file
                                   if x not in [rs1, rs2, rd1, rand_rs1, rand_rs2, rd2, swreg]
                                   ])
                             rand_rd = new_rand_rd
                     if rand_rs1 in [rd1, rs2, rd2, rand_rd, rand_rs2, rs1, swreg]:
                             new_rand_rs1 = random.choice([
                                   x for x in reg_file
                                   if x not in [rd1, rs2, rd2, rand_rd, rand_rs2, rs1, swreg]
                                   ])
            ...
            if swreg in [rd1, rs1, rs2, rd2, rand_rs1, rand_rs2, rand_rd ]:
                 newswreg = random.choice([
                     x for x in reg_file
                     if x not in [rd1, rs1, rs2, rd2, rand_rs1, rand_rs2, rand_rd]
                     ])
